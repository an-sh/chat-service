...
import { cleanup, clientConnect, parallel, series, startService } from './testutils.coffee';
...
export default function() {
  ...
  it('should emit leave echo on disconnect', function(done) {
    ...
    return chatService.addRoom(roomName1, null, () =>
      parallel([
        ...
        return parallel([
          cb =>
            socket1.once('roomLeftEcho', function(room, id, njoined) {
              expect(room).equal(roomName1);
              expect(id).equal(sid2);
              expect(njoined).equal(1);
              return cb();
          ...
          ,
          cb =>
            socket3.once('roomLeftEcho', function(room, id, njoined) {
              expect(room).equal(roomName1);
              expect(id).equal(sid2);
              expect(njoined).equal(1);
              return cb();
  ...
  it('should broadcast join and leave room messages', function(done) {
    ...
    return chatService.addRoom(roomName1, null, function() {
      ...
      return socket1.on('loginConfirmed', () =>
        socket1.emit('roomJoin', roomName1, function(error, njoined) {
          expect(error).not.ok;
          expect(njoined).equal(1);
          socket2 = clientConnect(user2);
    ...
    return chatService.addRoom(roomName1, null, () =>
      parallel([
        ...
        , function(error, data) {
          ...
          expect(data).include(user2);
          socket2.disconnect();
          return socket1.once('roomUserLeft', () =>
    ...
    return chatService.addRoom(roomName1, null, function() {
      ...
      return socket1.on('loginConfirmed', () =>
        socket1.emit('roomJoin', roomName1, () =>
          socket1.emit('roomMessage', roomName1, message, function(error, data) {
            expect(error).not.ok;
      ...
      parallel([
        ...
        function(cb) {
          ...
          return parallel([
            ...
            cb =>
              socket1.on('roomMessage', function(room, msg) {
                expect(room).equal(roomName1);
            ...
            ,
            cb =>
              socket2.on('roomMessage', function(room, msg) {
                expect(room).equal(roomName1);
                expect(msg.author).equal(user1);
                expect(msg.textMessage).equal(txt);
                expect(msg).ownProperty('timestamp');
      ...
      return socket1.on('loginConfirmed', () =>
        socket1.emit('roomJoin', roomName1, () =>
          socket1.emit('roomMessage', roomName1, message, () =>
            socket1.emit('roomRecentHistory', roomName1, function(error, data) {
              expect(error).not.ok;
              expect(data).empty;
              return done();
            }
  ...
  it('should send room history maximum size', function(done) {
    ...
    return chatService.addRoom(roomName1, null, function() {
      ...
      return socket1.on('loginConfirmed', () =>
        socket1.emit('roomJoin', roomName1, () =>
          socket1.emit('roomHistoryInfo', roomName1, function(error, data) {
            expect(error).not.ok;
  ...
  it('should sync history', function(done) {
    ...
    return chatService.addRoom(roomName1, null, function() {
      ...
      return series([
        cb =>
          socket1.on('loginConfirmed', () => socket1.emit('roomJoin', roomName1, cb)
          )
        ,
        cb => socket1.emit('roomMessage', roomName1, message, cb),
        cb => socket1.emit('roomMessage', roomName1, message, cb)
        ...
        return parallel([
          cb =>
            socket1.emit('roomHistoryGet', roomName1, 0, 10, function(error, data) {
              expect(error).not.ok;
              expect(data).lengthOf(2);
              expect(data[0]).include.keys('textMessage', 'author'
              , 'timestamp', 'id');
          ...
          ,
          cb =>
            socket1.emit('roomHistoryGet', roomName1, 1, 10, function(error, data) {
              expect(error).not.ok;
              expect(data).lengthOf(1);
              expect(data[0].id).equal(2);
              return cb();
          ...
          ,
          cb =>
            socket1.emit('roomHistoryGet', roomName1, 2, 10, function(error, data) {
              expect(error).not.ok;
              expect(data).empty;
              return cb();
            }
    ...
    return chatService.addRoom(roomName1, null, function() {
      ...
      return series([
        ...
        return parallel([
          ...
          ,
          cb =>
            socket1.emit('roomHistoryGet', roomName1, 3, 10, function(error, data) {
              expect(error).not.ok;
              expect(data).empty;
              return cb();
            }
      ...
      return socket1.on('loginConfirmed', () =>
        socket1.emit('roomJoin', roomName1, () =>
          socket1.emit('roomHistoryInfo', roomName1, function(error, data) {
            ...
            return socket1.emit('roomMessage', roomName1, message, () =>
              socket1.emit('roomHistoryInfo', roomName1, function(error, data) {
                expect(error).not.ok;
      ...
      return parallel([
        ...
        function(cb) {
          ...
          return socket1.emit('roomUserSeen', roomName1, user2, function(error, info1) {
            ...
            return socket2.emit('roomLeave', roomName1, () =>
              socket1.emit('roomUserSeen', roomName1, user2, function(error, info2) {
  ...
  it('should get empty seen info for unseen users', function(done) {
    ...
    return chatService.addRoom(roomName1, null, function() {
      ...
      return socket1.on('loginConfirmed', () =>
        socket1.emit('roomJoin', roomName1, () =>
          socket1.emit('roomUserSeen', roomName1, user2, function(error, info) {
            expect(error).not.ok;
